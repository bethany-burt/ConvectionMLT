...
def main(layers: tuple[int, ...] = (96, 192), out: Path = DEFAULT_OUT) -> dict:
    ...
    meta = {
        ...
        "table_checksum_sha256": checksum,
        "checksum_note": (
            "checksum_sha256 and file_sha256 are the SHA-256 of the HDF5 file bytes. "
            "table_checksum_sha256 hashes kpoints+metadata only. Do not regenerate "
            "this table in a live HELIOS job."
        ),
