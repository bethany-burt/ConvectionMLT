...
- **`convective_grid/convective_flux_v2.py`** - Main convective flux solver implementing MLT
- **`collect_parameter_sweep_data.py`** - Parameter sweep data collection
...
See individual script docstrings and notebooks for usage examples.
